...
namespace driver {
    ...
    bool attach_to_process(HANDLE driver_handle, const DWORD pid) {
        ...
        return DeviceIoControl(driver_handle, code::attach, &r, sizeof(r), &r, sizeof(r), nullptr, nullptr);
    }
    ...
    T read_memory(HANDLE driver_handle, const std::uintptr_t addr) {
        ...
        DeviceIoControl(driver_handle, code::read, &r, sizeof(r), &r, sizeof(r), nullptr, nullptr);
    ...
    void write_memory(HANDLE driver_handle, const std::uintptr_t addr, const T& value) {
        ...
        DeviceIoControl(driver_handle, code::write, &r, sizeof(r), &r, sizeof(r), nullptr, nullptr);
    }
